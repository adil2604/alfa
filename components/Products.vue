    ...
    <div class="card-content">
      <div class="media">
        <div class="media-content">
          <p class="title is-5">{{ product.title |truncate(20) }}</p>
        </div>
        <div>
      ...
      <div class="content is-clearfix">
        ...
        <div class="is-pulled-right">
          <div class="col">
            ...
            <div class="buttons">
              <button class="btn btn-primary" style="width: 6rem" v-if="!product.isAddedToCart" @click="addToCart(product.id)">{{
                  addToCartLabel
                }}
              </button>
              <button class="button is-text" v-if="product.isAddedToCart" @click="removeFromCart(product.id, false)">
                {{ removeFromCartLabel }}
              </button>
            </div>
          </div>
